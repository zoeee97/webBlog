import{_ as t,X as o,Y as l,Z as s,$ as n,a0 as e,a1 as p,C as c}from"./framework-b0b21ae2.js";const i={},r=p(`<h1 id="vue-node项目打包优化并部署上线-nginx配置" tabindex="-1"><a class="header-anchor" href="#vue-node项目打包优化并部署上线-nginx配置" aria-hidden="true">#</a> vue+node项目打包优化并部署上线+nginx配置</h1><h2 id="一、配置config-js进行vue打包优化配置" tabindex="-1"><a class="header-anchor" href="#一、配置config-js进行vue打包优化配置" aria-hidden="true">#</a> 一、配置config.js进行vue打包优化配置</h2><p>用到的优化手段有：cdn加速、公共代码抽离、代码压缩、图片文件压缩。 因此需要先下载的依赖有：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>//代码压缩
